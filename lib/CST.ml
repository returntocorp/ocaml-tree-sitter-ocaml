...
type quoted_string_content =
  [
    ...
    | `HT of Token.t (* "\t" *)
    | `LBRACKAT of Token.t (* "[@" *)
    | `LBRACKATAT of Token.t (* "[@@" *)
    | `LBRACKATATAT of Token.t (* "[@@@" *)
    | `Pat_714c625 of pat_714c625 (*tok*)
    | `Null of null (*tok*)
...
and labeled_argument = [
    `Label of label
  | `Label_COLON_choice_simple_exp of (
...
and parameter_ = [
  ...
  | `Label_COLON_LPAR_pat_ext_opt_typed_EQ_seq_exp_ext_RPAR of (
        label
      * Token.t (* ":" *)
      * Token.t (* "(" *)
      * pattern_ext
